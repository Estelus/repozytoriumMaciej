...
class TestAddPlayerWithYoutubeLink(unittest.TestCase):
    ...
    def test_add_player_with_youtube_link(self):
        ...
        add_a_player.click_on_add_youtube_button()
        add_a_player.wait_for_element_to_be_clickable(add_a_player.add_youtube_button_xpath)
        add_a_player.type_in_add_youtube_link("https://youtu.be/JxS5E-kZc2s")
