...
class AddPlayerPage(BasePage):
    ...
    youtube_first_field_xpath = "//input[@name='webYT[0]']"
    ...
    def click_on_add_youtube_button(self):
        self.click_on_the_element(self.add_youtube_button_xpath)
    def type_in_add_youtube_link(self, youtube):
        self.field_send_keys(self.youtube_first_field_xpath, youtube)